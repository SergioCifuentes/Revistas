...
<form method="POST" action="/Revistas/RedireccionesSuscriptor">
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                <li class="nav-item ">
                    <input name="Mis Revistas" class="btn btn-light" type="submit" style="font-size: 25px;width: 240px" value="Mis Revistas"> 
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item active">
                    <button name="Pagos" value="Pagos" class="btn btn-dark" type="submit" style="font-size: 25px;width: 240px"> Pagos<% if (atrazos> 0) {%>
